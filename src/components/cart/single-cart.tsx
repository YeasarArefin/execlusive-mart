...
export default function SingleCart({ product }: { product: ProductType; }) {
    ...
    const selectedColor: ColorType | undefined = colors && colors[0];
    const selectedVariant: ProductVariant | undefined = variants && variants[0];
    const selectedImage: ProductImageType | undefined = images && images[0];
